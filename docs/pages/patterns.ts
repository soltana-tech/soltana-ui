      ...
      <div class="specimen__preview p-0">
        <nav class="flex items-center justify-between px-6 py-3" style="background: var(--surface-1); border-bottom: 1px solid var(--border-default)">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="avatar avatar-sm" style="background: var(--dracula-green); color: var(--dracula-bg)">JD</div>
          </div>
        </nav>
      </div>
    </div>
          ...
          <tbody>
            ${[
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-2">
                    <div class="avatar avatar-sm" style="background: ${u.color}; color: var(--dracula-bg)">${u.initials}</div>
