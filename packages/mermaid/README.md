...
Mermaid theme bridge for [Soltana UI](../soltana-ui) — synchronizes diagram colors with the active theme tier.
...
These files are generated by [`@soltana-ui/tokens`](../tokens) during the build process.
